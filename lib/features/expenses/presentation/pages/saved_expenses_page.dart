...
class SavedExpensesPage extends StatelessWidget {
  const SavedExpensesPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => context.read<ExpenseCubit>(),
      child: Scaffold(
        appBar: AppBar(
  ...
  void _reloadPage(BuildContext context) {
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation1, animation2) => const SavedExpensesPage(),
...
class _SavedReportsBody extends StatelessWidget {
  const _SavedReportsBody();
